...
- **Settings → Contact**: shows **app version**, maintainer **name**, and **email** (`git config user.name` / `user.email` when running from source; otherwise bundled defaults for frozen builds).
