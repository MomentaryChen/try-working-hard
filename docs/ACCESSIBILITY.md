...
- **Click the “Interval”, “Interval jitter (± sec)”, “Nudge (pixels)”, “Path speed”, or “Path” labels** to move focus to the corresponding field (the label cursor becomes a hand where supported).
