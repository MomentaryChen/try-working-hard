...
STRINGS: dict[Lang, dict[str, str]] = {
    "zh": {
        ...
        "schedule_window_title": "上班時段（09:00–18:00）",
        "schedule_window_hint": "啟用後僅在週一至週五 09:00–18:00（本機時間）之間觸發微動，下班後與週末會自動暫停。",
        "status_schedule_wait": "狀態：排程暫停 · 下次上班時段約 {cd}",
        "log_start_schedule": "已啟用上班時段：週一至週五 09:00–18:00（本機時間）。",
    ...
    "en": {
        ...
        "schedule_window_title": "Work hours (09:00–18:00)",
        "schedule_window_hint": "When on, nudges run only Mon–Fri, 09:00–18:00 local time; evenings and weekends stay paused—useful for long background runs.",
        "status_schedule_wait": "Status: schedule paused · resuming in ~{cd}",
        "log_start_schedule": "Work-hours limit on: Mon–Fri, 09:00–18:00 (local time).",
