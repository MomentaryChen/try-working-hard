...
def test_nudge_trajectory_delegates_horizontal() -> None:
    ...
    set_pos = MagicMock()
    sleep = MagicMock()
    nudge_trajectory("horizontal", 5, get_pos=get_pos, set_pos=set_pos, sleep=sleep)
    set_pos.assert_has_calls(
        [
            ((105, 200),),
            ((100, 200),),
...
def test_nudge_circle_restores_start() -> None:
    ...
    set_pos = MagicMock()
    sleep = MagicMock()
    nudge_trajectory("circle", 10, get_pos=get_pos, set_pos=set_pos, sleep=sleep)
...
def test_nudge_square_restores_start() -> None:
    ...
    set_pos = MagicMock()
    sleep = MagicMock()
    nudge_trajectory("square", 8, get_pos=get_pos, set_pos=set_pos, sleep=sleep)
    assert get_pos.call_count == 1
...
def test_nudge_pattern_zero_or_negative_no_set_pos() -> None:
    ...
    set_pos = MagicMock()
    sleep = MagicMock()
    nudge_trajectory("circle", 0, get_pos=get_pos, set_pos=set_pos, sleep=sleep)
    get_pos.assert_not_called()
    set_pos.assert_not_called()
    sleep.assert_not_called()
